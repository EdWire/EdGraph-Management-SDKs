...
{
    /// <summary>
    /// IdentityApiClientV1ClientProfileResponse
    /// </summary>
    [DataContract(Name = "IdentityApi.Client.V1.ClientProfileResponse")]
    public partial class IdentityApiClientV1ClientProfileResponse : IEquatable<IdentityApiClientV1ClientProfileResponse>, IValidatableObject
    {
        ...
        public IdentityApiClientV1AccessTokenType? AccessTokenType { get; set; }

        /// <summary>
        /// Gets or Sets TokenUsage
        /// </summary>
        [DataMember(Name = "tokenUsage", EmitDefaultValue = false)]
        public IdentityApiClientV1TokenUsage? TokenUsage { get; set; }

        /// <summary>
        /// Gets or Sets RefreshTokenExpiration
        /// </summary>
        [DataMember(Name = "refreshTokenExpiration", EmitDefaultValue = false)]
        public IdentityApiClientV1TokenExpiration? RefreshTokenExpiration { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityApiClientV1ClientProfileResponse" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "clientSecrets", EmitDefaultValue = true)]
        public List<IdentityApiClientV1Secret> ClientSecrets { get; private set; }

        /// <summary>
        /// Returns false as ClientSecrets should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeClientSecrets()
        {
            return false;
        }
        /// <summary>
        ...
        public List<IdentityApiClientV1Claim> Claims { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityApiClientV1ClientProfileResponse {\n");
        ...
        {
            return this.Equals(input as IdentityApiClientV1ClientProfileResponse);
        }

        /// <summary>
        /// Returns true if IdentityApiClientV1ClientProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiClientV1ClientProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiClientV1ClientProfileResponse input)
        {
            if (input == null)
            {
                return false;
