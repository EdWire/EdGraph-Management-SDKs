...
namespace EdGraph.Management.Client.Model
{
    ...
    public partial class ApplicationApiApplicationV1ApplicationListResponse : IEquatable<ApplicationApiApplicationV1ApplicationListResponse>, IValidatableObject
    {
        ...
        public ApplicationApiApplicationV1ApplicationListResponse(string tenantId = default(string), string applicationId = default(string), string applicationName = default(string), string version = default(string), string tags = default(string), string groups = default(string), ApplicationApiApplicationV1ApplicationStatus? applicationStatus = default(ApplicationApiApplicationV1ApplicationStatus?), bool isInternal = default(bool), string createdBy = default(string), string createdDateTime = default(string), string lastModifiedBy = default(string), string lastModifiedDateTime = default(string))
        {
