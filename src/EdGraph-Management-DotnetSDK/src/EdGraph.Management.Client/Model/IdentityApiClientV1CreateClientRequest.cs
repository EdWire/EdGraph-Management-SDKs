...
namespace EdGraph.Management.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityApi.Client.V1.CreateClientRequest")]
    public partial class IdentityApiClientV1CreateClientRequest : IEquatable<IdentityApiClientV1CreateClientRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityApiClientV1CreateClientRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityApiClientV1CreateClientRequest {\n");
        ...
        {
            return this.Equals(input as IdentityApiClientV1CreateClientRequest);
        }

        /// <summary>
        /// Returns true if IdentityApiClientV1CreateClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiClientV1CreateClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiClientV1CreateClientRequest input)
        {
            if (input == null)
            {
                return false;
