...
{
    /// <summary>
    /// RegistrationApiRegistrationV1CreateTenantRegistrationRequest
    /// </summary>
    [DataContract(Name = "RegistrationApi.Registration.V1.CreateTenantRegistrationRequest")]
    public partial class RegistrationApiRegistrationV1CreateTenantRegistrationRequest : IEquatable<RegistrationApiRegistrationV1CreateTenantRegistrationRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistrationApiRegistrationV1CreateTenantRegistrationRequest" /> class.
        /// </summary>
        ...
        public RegistrationApiRegistrationV1CreateTenantRegistrationRequest(RegistrationApiRegistrationV1TenantType? tenantType = default(RegistrationApiRegistrationV1TenantType?), string registrationId = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string state = default(string), string organizationIdentifier = default(string), string organizationName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegistrationApiRegistrationV1CreateTenantRegistrationRequest {\n");
        ...
        {
            return this.Equals(input as RegistrationApiRegistrationV1CreateTenantRegistrationRequest);
        }

        /// <summary>
        /// Returns true if RegistrationApiRegistrationV1CreateTenantRegistrationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RegistrationApiRegistrationV1CreateTenantRegistrationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegistrationApiRegistrationV1CreateTenantRegistrationRequest input)
        {
            if (input == null)
            {
                return false;
