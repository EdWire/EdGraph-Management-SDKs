...
{
    /// <summary>
    /// DataSyncApiJobTypeV1UpdateJobTypeRequest
    /// </summary>
    [DataContract(Name = "DataSyncApi.JobType.V1.UpdateJobTypeRequest")]
    public partial class DataSyncApiJobTypeV1UpdateJobTypeRequest : IEquatable<DataSyncApiJobTypeV1UpdateJobTypeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSyncApiJobTypeV1UpdateJobTypeRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataSyncApiJobTypeV1UpdateJobTypeRequest {\n");
        ...
        {
            return this.Equals(input as DataSyncApiJobTypeV1UpdateJobTypeRequest);
        }

        /// <summary>
        /// Returns true if DataSyncApiJobTypeV1UpdateJobTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DataSyncApiJobTypeV1UpdateJobTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataSyncApiJobTypeV1UpdateJobTypeRequest input)
        {
            if (input == null)
            {
                return false;
